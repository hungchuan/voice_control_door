...
#define IO_USERNAME  "hungchuan"
#define IO_KEY       "aio_shBw91s0RrBoK6Wn7PKuPz1krjX8"


/******************************* WIFI Configuration **************************************/

#define WIFI_SSID       "DecoM5_22"
#define WIFI_PASS       "Dd4698338"
...
const char* topic_subscribe = "ha/1F/garage/switch"; 
...
/***************************  Adafruit IO  **********************************/
  ...
  AdafruitIO_WiFi io(IO_USERNAME, IO_KEY, esid.c_str(), epass.c_str());
/****************************************************************************/
...
void handleMessage(AdafruitIO_Data *data) {
  ...
  Serial.println(angle);
   ...
   if (cmd.equalsIgnoreCase("garage"))
   {  
	    if (1==angle)
		{
			Open_Garage();
